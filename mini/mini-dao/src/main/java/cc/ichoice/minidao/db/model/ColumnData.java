package cc.ichoice.minidao.db.model;
...
public class ColumnData {
    ...
    private String columnNameByHump;//字段驼峰命名
    ...
    public String getColumnNameByHump() {
        return columnNameByHump;
    }

    public void setColumnNameByHump(String columnNameByHump) {
        this.columnNameByHump = columnNameByHump;
    }
}

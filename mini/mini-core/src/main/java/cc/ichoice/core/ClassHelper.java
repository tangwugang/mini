...
import cc.ichoice.factory.InstanceFactory;
 ...
 * 获取Class类
 * @author twg
 * @see cc.ichoice.core.impl.DefaultClassScanner
 *
 */
public class ClassHelper {
     ...
     * 获取基础包名
     */
    private static final String basePackage = ConfigHelper.getString("mini.app.base_package");

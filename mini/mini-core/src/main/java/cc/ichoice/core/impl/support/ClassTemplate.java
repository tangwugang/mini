...
public abstract class ClassTemplate {
    ...
    public final List<Class<?>> getClassList() {
        ...
        try {
            // 从包名获取 URL 类型的资源
            Enumeration<URL> urls = ClassUtils.getDefaultClassLoader().getResources(packageName.replace(".", "/"));
            // 遍历 URL 资源
            ...
            DefaultLoggerFactory.getInstance().getLogger(ClassTemplate.class).error("获取类出错！", e);
        }
        return classList;
    }
